...
const userID = id.description("FK to users.UserID");
const category = joi.number().integer().min(1).description("FK to categories");
...
export const budgetsSchema = {
  mutableFields: ["BudgetName", "TotalAmount", "BudgetDate", "CategoryID"],
  recordSchema: joi.object({
